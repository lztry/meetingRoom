...
<link href='${basepath}/css/plugins/fullcalendar/fullcalendar.print.min.css' rel='stylesheet' media='print' />
	        ...
	        <div class="col-md-3" style="font-size: 16px;margin-top: 2%;padding-left: 30px;">
                     ...
                     <%--  <select class="form-control">
                      ...
                      ${room.name}<br/>
                        ${room.departmentName}<br/>
				              ...
				              <c:if test="${ room.isCheck==0}">不</c:if>需要审核
                ...
                <div class="row">
	                <div class="panel panel-info">
	                    ...
	                    <div class="panel-body">
	                        <h4  align="center" style="font-weight:bold;"> 在浅绿色区域鼠标点击下滑选择时间</h4>
	                       <h4 align="center"> 白色区域为无效区域</h4>
	                        <ul >
  ...
  <div class="modal" tabindex="-1" role="dialog" id="myModal" >
         <div class="modal-dialog" role="document">
             <div class="modal-content">
                 ...
                 <form id="appointForm" method="post" action="${basepath}/appoint/appoint.do"  >
